...
const adminNavItems = [
  ...
  { label: "API Keys", href: "/admin/api-keys", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" },
...
export function AdminSidebar({ mobileOpen = false, onMobileClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 h-full bg-gray-900 border-r border-gray-700 z-20 transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-3 border-t border-gray-700 space-y-2">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2 rounded text-sm text-gray-400 hover:bg-gray-800 hover:text-white transition-colors"
          >
            <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
